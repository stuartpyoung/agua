...
sub dbtype {
	...
	return $self->{_dbtype} = $dbtype if defined $dbtype;	
	return $self->{_dbtype} if defined $self->{_dbtype};
}
...
sub database {
	...
	return $self->{_database} = $database if defined $database;	
	return $self->{_database} if defined $self->{_database};
}
...
sub dbh {
	...
	return $self->{_dbh} = $dbh if defined $dbh;	
...
sub user {
	...
	return $self->{_user} = $user if defined $user;	
	return $self->{_user} if defined $self->{_user};
}
sub password {
	my $self	=	shift;
	my $password	=	shift;

	return $self->{_password} = $password if defined $password;	
	return $self->{_password} if defined $self->{_password};
}
