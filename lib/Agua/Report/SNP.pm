...
sub reportfile
{
    ...
    print "Report::SNP::reportfile     fileroot not defined. Exiting\n" and exit if not defined $fileroot;
	print "Report::SNP::reportfile     project not defined. Exiting\n" and exit if not defined $project;
	print "Report::SNP::reportfile     workflow not defined. Exiting\n" and exit if not defined $workflow;
	print "Report::SNP::reportfile     report not defined. Exiting\n" and exit if not defined $report;
	print "Report::SNP::reportfile     username not defined. Exiting\n" and exit if not defined $username;
	...
	print "Can't create reportfolder: $reportfolder\n" and die if not -d $reportfolder;
...
sub filterReport
{
    ...
    if ( not -f $diffsfile )	
    {
        print "{ error: 'Report::SNP::filterReport    username: $username Could not find diffs file: $diffsfile' }";
        exit 1;
    }
