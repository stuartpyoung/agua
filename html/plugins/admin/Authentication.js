dojo.provide("plugins.admin.Authentication");
	...
	[ dijit._Widget, dijit._Templated, plugins.core.Common ],
{
	...
	templatePath: dojo.moduleUrl("plugins", "admin/templates/authentication.html"),
	...
	cssFiles : [ "plugins/admin/css/authentication.css" ],
	...
	constructor : function(args)
	{
		...
		this.authentication = args.parentWidget.authentication;
	...
	startup : function ()
	{
		...
		this.tabContainer.addChild(this.authenticationTab);
		this.tabContainer.selectChild(this.authenticationTab);
	...
	reloadUserTabs : function ()
	{
		...
		var tabPaneNames = ["plugins.admin.GroupAuthentication"];
	...
	setTable : function ()
	{
		...
		while ( this.authenticationTable.firstChild )
		{
			this.authenticationTable.removeChild(this.authenticationTable.firstChild);
		}

		var dataArray = new Array;
		var userArray = Agua.getAuthentication();
		...
		dojo.connect(textarea, "onkeypress", function(evt){
			...
			if ( key == 13 )
			{
				...
				if ( user.username != '' )
					...
					//&& user.email != '' )
				{
					// REMOVE ORIGINAL user OBJECT FROM Agua.authentication ARRAY
					// THEN ADD NEW SOURCE OBJECT TO Agua.authentication ARRAY
	...
	// REMOVE USER FROM this.authentication
	removeUser : function (username)
	{
		...
		// REMOVING SOURCE FROM Agua.authentication
	...
	addUser : function (user)
	{
		...
		if ( password == '' || password.match(/^\s*its-a-secret\s*$/) )
		{
