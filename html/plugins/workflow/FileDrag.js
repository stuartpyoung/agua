dojo.provide("plugins.project.FileDrag");

dojo.require("dojox.widget.RollingList");
dojo.require("dojo.i18n"); 
dojo.requireLocalization("dojox.widget", "FileDrag", null, ""); 

dojo.require("plugins.project._GroupDragPane");

dojo.declare("plugins.project._FileInfoPane", 
...
dojo.declare("plugins.project.FileDrag", dojox.widget.RollingList, {
...
//return;
	...
	getPaneForItem: function(/*item*/ item, /* dijit._Contained */ parentPane, /* item[]? */ children){
		...
		//if( ! item || item.children )
		{
			...
			groupDragPane = new plugins.project._GroupDragPane(
				{
		...
		else if(this.store.isItem(item) && !this.store.getValue(item, "directory"))
		{
			...
			groupDragPane = new plugins.project._FileInfoPane({});
		}
