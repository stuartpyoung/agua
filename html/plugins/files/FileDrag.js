...
// CSS FILES
cssFiles : [
	dojo.moduleUrl("dojo") + "/../dojox/widget/Dialog/Dialog.css",
	dojo.moduleUrl("plugins.files") + "/FileDrag/FileDrag.css"
],

/*
// ORIGINAL dojox.widget.RollingListPane TEMPLATE

// templateString: string
//	our template
//templateString: '<div class="dojoxRollingList" style="height: auto !important; width: 100% !important;"><table><tbody><tr><td dojoAttachPoint="containerNode"></td></tr></tbody></div>',

// ADAPTED dojox.widget.RollingList TEMPLATE

// 	//		The template to be used to construct the widget.
//templateString: "<div style='height: 100% !important; width: 100% !important;' class=\"dojoxRollingList ${className}\"\n\t><div class=\"dojoxRollingListContainer\" dojoAttachPoint=\"containerNode\" dojoAttachEvent=\"onkeypress:_onKey\"\n\t></div></div>\n",
*/
...
// ORIGINAL dojox.widget.RollingList TEMPLATE


//		The template to be used to construct the widget.
//templateString: dojo.cache("dojox.widget", "RollingList/RollingList.html", "<div class=\"dojoxRollingList ${value: "<div class=\"dojoxRollingList ${className}\"\r\n\t><div class=\"dojoxRollingListContainer\" dojoAttachPoint=\"containerNode\" dojoAttachEvent=\"onkeypress:_onKey\"\r\n\t></div\r\n\t><div class=\"dojoxRollingListButtons\" dojoAttachPoint=\"buttonsNode\"\r\n        ><button dojoType=\"dijit.form.Button\" dojoAttachPoint=\"okButton\"\r\n\t\t\t\tdojoAttachEvent=\"onClick:_onExecute\">${okButtonLabel}</button\r\n        ><button dojoType=\"dijit.form.Button\" dojoAttachPoint=\"cancelButton\"\r\n\t\t\t\tdojoAttachEvent=\"onClick:_onCancel\">${cancelButtonLabel}</button\r\n\t></div\r\n></div>\r\n",className}\"\n\t><div class=\"dojoxRollingListContainer\" dojoAttachPoint=\"containerNode\" dojoAttachEvent=\"onkeypress:_onKey\"\n\t></div\n\t><div class=\"dojoxRollingListButtons\" dojoAttachPoint=\"buttonsNode\"\n        ><button dojoType=\"dijit.form.Button\" dojoAttachPoint=\"okButton\"\n\t\t\t\tdojoAttachEvent=\"onClick:_onExecute\">${okButtonLabel}</button\n        ><button dojoType=\"dijit.form.Button\" dojoAttachPoint=\"cancelButton\"\n\t\t\t\tdojoAttachEvent=\"onClick:_onCancel\">${cancelButtonLabel}</button\n\t></div\n></div>\n"),
*/
...
getPaneForItem : function(/*item*/ item, /* dijit._Contained */ parentPane, /* item[]? */ children){
	...
	//if( ! item || item.children )
	{
		...
		// SET BASE CLASS
		//groupDragPane.attr('baseClass', 'fileDrag');
