	...
	[ dijit._Widget, dijit._Templated, plugins.core.Common ],
{
	...
	cssFiles : [ "dojo-1.5.0/dojox/layout/resources/ExpandoPane.css" ],
				//"dojo-1.5.0/dijit/tests/css/dijitTests.css" ],

	// attachWidget: WIDGET. APPEND this.containerNode TO THIS WIDGET
	...
	// if you were to include some parameters here.
...
//	var leftWidget = new dijit.layout.ContentPane({region: "left", splitter: true}, leftPane);
	...
	var trackCreate = function(track, hint) {
		...
		if ("avatar" == hint) {
			...
			// ADDED: trackBaseUrl TO INCLUDE data DIR
			var trackBaseUrl = brwsr.dataRoot; // + "data/";
